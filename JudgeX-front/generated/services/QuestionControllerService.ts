...
import type { QuestionSubmitGetRequest } from '../models/QuestionSubmitGetRequest';
...
export class QuestionControllerService {
    ...
    /**
     * listQuestionVOByPage_Admin
     * @param questionQueryRequest questionQueryRequest
     * @returns BaseResponse_Page_Question_ OK
     * @returns any Created
     * @throws ApiError
     */
    public static listQuestionVoByPageAdminUsingPost(
        questionQueryRequest: QuestionQueryRequest,
    ): CancelablePromise<BaseResponse_Page_Question_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/question/list/page/vo_admin',
            body: questionQueryRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
    ...
    /**
     * getQuestionSubmit
     * @param questionSubmitGetRequest questionSubmitGetRequest
     * @returns BaseResponse_QuestionSubmitVO_ OK
     * @returns any Created
     * @throws ApiError
     */
    public static getQuestionSubmitUsingPost(
        questionSubmitGetRequest: QuestionSubmitGetRequest,
    ): CancelablePromise<BaseResponse_QuestionSubmitVO_ | any> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/question/question_submit/get',
            body: questionSubmitGetRequest,
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
                404: `Not Found`,
